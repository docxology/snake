"""Baseline snake generation for dimensions 1-16.

Known-snake retrieval plus lightweight pattern-based generation for dimensions
without database entries. Moved verbatim from
``snake_in_box/scripts/generate_snakes_for_all_dimensions.py`` so that scripts
and analysis workflows share one library implementation (thin-orchestrator
contract, 2026-09 scripts audit).
"""

from snake_in_box.benchmarks.known_snakes import get_known_snake
...
def generate_all() -> dict:
    ...
    -------
    dict
        Mapping of dimension -> SnakeNode for every successfully generated snake.
    """
